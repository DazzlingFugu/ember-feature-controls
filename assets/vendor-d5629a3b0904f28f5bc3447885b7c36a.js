...
for(var n in t)e(n,t[n])}}(),e("jquery",{default:self.jQuery}),e("rsvp",{default:Ember.RSVP})}(),createDeprecatedModule("ember/resolver"),createDeprecatedModule("resolver"),define("ember-feature-controls/components/feature-controls",["exports","ember-feature-controls/templates/components/feature-controls","ember-get-config","ember-local-storage"],function(e,t,n,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
var i=n.default.featureFlags,o=n.default.featureControls
e.default=Ember.Component.extend({layout:t.default,features:Ember.inject.service(),featuresLS:(0,r.storageFor)("feature-controls"),showRefresh:!0,showReset:!0,featureControls:o,featureFlags:i,init:function(){this._super.apply(this,arguments),this.refresh()},_normalizeFlag:function(e){return Ember.get(this,"features._normalizeFlag")(e)},refresh:function(){var e=this,t=this.get("featureFlags"),n={}
for(var r in t)n[this._normalizeFlag(r)]=t[r]
var i=(Ember.get(this,"features.flags")||[]).map(function(t){var r=(o&&e.get("featureControls.metadata")||[]).find(function(n){return e._normalizeFlag(n.key)===t})||{},i=e.get("featureControls.useLocalStorage")&&void 0!==e.get("featuresLS."+t),s={key:t,isEnabled:i?e.get("featuresLS."+t):Ember.get(e,"features").isEnabled(t),default:n[t]||!1}
return Ember.assign({},r,s)})
...
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"oNy+7ifV",block:'{"symbols":[],"statements":[[6,"h1"],[7],[0,"Feature Flags Controls Room"],[8],[0,"\\n"],[1,[18,"feature-controls"],false],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"ember-feature-controls/templates/features-list.hbs"}})}),define("ember-feature-flags/helpers/feature-flag",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
